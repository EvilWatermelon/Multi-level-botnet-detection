...
Xing et al. \cite{Xing2021SurveyOB} stellt eine zusammengefasste Unterteilung von Methoden zur Botnetzerkennung vor. Dabei gehen sie aber nicht auf konkrete Methoden
...
\cite{SAlrayes2022ModelingOB,DBLP:journals/comcom/Alani22,Habtamu2022ASR, D2022ARO} zeigen. Wazzan et al. \cite{Wazzan2021InternetOT} schlägt die Kombination 
...
\subsection*{Techniken zur Erkennung von Botnetzen}
% - Flow, anomaly, flux, dga, bot infection detection
Die erste vorgestellte Technik aus Kapitel \ref{sec:theory} ist die Flowbasierte Erkennung von Botnetzen. Obeidat und Yaqbeh \cite{DBLP:journals/jece/ObeidatY22} sowie Duan et al. \cite{DBLP:journals/ijdsn/DuanZWX22}
stellen Arbeiten zur Erkennung von Botnetzen anhand von Netzwerkverkehr vor. Beide Arbeiten analysieren TCP, UDP und IP Pakete und klassifizieren über ML und unterteilen den Netzwerkverkehr in normalen und abnormalen Verkehr.
Während beim Netzwerkverkehr die gleichen Pakete untersucht werden, unterscheiden sich die Arbeiten bei der Nutzung von ML. Duan et al. nutzen zur Klassifizierung des Netzwerkverkehrs ein autoencoder Modell \cite{vincent2010stacked}
mit einem Gradient Boosting Decision Tree (GBDT) Algorithmus \cite{DBLP:conf/nips/KeMFWCMYL17}. Obeidat und Yaqbeh nutzen einen genetischen Algorithmus \cite{DBLP:journals/mta/KatochCK21} zur Klassifizierung. \\ \\
